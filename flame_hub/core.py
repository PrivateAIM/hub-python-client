...
class CoreClient(BaseClient):
    ...
    def find_nodes(self, page_params: PageParams = None, filter_params: FilterParams = None) -> ResourceList[Node]:
        return self._find_all_resources(Node, page_params, filter_params, "nodes")
    ...
    ) -> ResourceList[MasterImageGroup]:
        return self._find_all_resources(MasterImageGroup, page_params, filter_params, "master-image-groups")
    ...
    def find_master_images(
        self, page_params: PageParams = None, filter_params: FilterParams = None
    ) -> ResourceList[MasterImage]:
        return self._find_all_resources(MasterImage, page_params, filter_params, "master-images")
    ...
    def find_analysis_bucket_files(
        self, page_params: PageParams = None, filter_params: FilterParams = None
    ) -> ResourceList[AnalysisBucketFile]:
        return self._find_all_resources(AnalysisBucketFile, page_params, filter_params, "analysis-bucket-files")
