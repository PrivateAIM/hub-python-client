...
class CoreClient(BaseClient):
    ...
    def update_node(
        ...
        registry_id: Registry | str | uuid.UUID | UNSET_T = UNSET,
        public_key: str | UNSET_T = UNSET,
    ) -> Node:
    ...
    def update_project(
        ...
        description: str | UNSET_T = UNSET,
        master_image_id: MasterImage | str | uuid.UUID | UNSET_T = UNSET,
    ...
    def update_project_node(
        ...
        comment: str | UNSET_T = UNSET,
        approval_status: ProjectNodeApprovalStatus | UNSET_T = UNSET,
    ):
        return self._update_resource(
            ProjectNode,
    ...
    def update_analysis(
        ...
        name: str | UNSET_T = UNSET,
        description: str | UNSET_T = UNSET,
        master_image_id: MasterImage | uuid.UUID | str | UNSET_T = UNSET,
        image_command_arguments: list[MasterImageCommandArgument] | UNSET_T = UNSET,
    ) -> Analysis:
        return self._update_resource(
            Analysis,
    ...
    def update_analysis_node(
        ...
        comment: str | UNSET_T = UNSET,
        approval_status: AnalysisNodeApprovalStatus | UNSET_T = UNSET,
        run_status: AnalysisNodeRunStatus | UNSET_T = UNSET,
    ) -> AnalysisNode:
        return self._update_resource(
            AnalysisNode,
    ...
    def update_analysis_node_log(
        ...
        error_code: str | UNSET_T = UNSET,
        status: str | UNSET_T = UNSET,
        status_message: str | UNSET_T = UNSET,
    ) -> AnalysisNodeLog:
        return self._update_resource(
            AnalysisNodeLog,
    ...
    def update_registry(
        ...
        account_name: str | UNSET_T = UNSET,
        account_secret: str | UNSET_T = UNSET,
    ) -> Registry:
        return self._update_resource(
            Registry,
